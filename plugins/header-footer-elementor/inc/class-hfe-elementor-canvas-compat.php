...
class HFE_Elementor_Canvas_Compat {
     ...
     * OR if display template is "Elementor Canvas CPT Books".
	 */
	public function render_header() {

		// bail if current page template is not Elemenntor Canvas.
		if ( 'elementor_canvas' !== get_page_template_slug() && 'single-cp_books.php' !== get_page_template_slug() ) {
			return;
		}
        
        if ( 'single-cp_books.php' == get_page_template_slug() ) {
            hfe_render_header();
        }
