...
class DCE_License {
    ...
    static public function show_license_form() {
        ...
        $licence_key_hidden = 'www.nulled.ch';
        ...
        <div class="dce-notice <?php echo $classes; ?>">
            ...
            <form action="" method="post">
                <?php _e('Your key', DCE_TEXTDOMAIN ); ?>: <input type="text" name="licence_key" value="<?php if ($dce_activated) { echo $licence_key_hidden; } else { echo $licence_key_hidden; } ?>" id="licence_key" value="dce-xxxxxxxx-xxxxxxxx-xxxxxxxx" style="width: 240px; max-width: 100%;">
