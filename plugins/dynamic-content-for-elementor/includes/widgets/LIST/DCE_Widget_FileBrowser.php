...
class DCE_Widget_FileBrowser extends DCE_Widget_Prototype {
    ...
    protected function _register_controls() {
        ...
        */
        ...
        $this->add_control(
            'metadata_heading',
            [
                'label' => __( 'File MetaData', DCE_TEXTDOMAIN ),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} h4' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
       ...
       $this->add_control(
        ...
        $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .dce-file-search-form h3' => 'color: {{VALUE}};',
                    ],
                    'condition' => [
                        'search_text!' => '',
                    ],
        ...
        $this->add_group_control(
          Group_Control_Typography::get_type(), [
            ...
            'label' => __('Typography', DCE_TEXTDOMAIN),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .dce-file-search-form h3',
            'condition' => [
                    'search_text!' => '',
                ],
          ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dce-file-search-form h3' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
    ...
    protected function render() {
        ...
        if ($settings['path_selection'] == 'uploads') {
        ...
        if ($baseDir) {
            ...
            if (is_dir($this->getRootDir($baseDir, $settings))) {
                ...
                if (isset($settings['search']) && $settings['search']) {
                    $this->displayFileSearch($settings['search_text']);
                }

                if (isset($settings['title']) && $settings['title']) {
                    echo '<h4>' . $baseTitle . '</h4>';
                }
                ...
                echo '>';
                $this->dirToHtml($this->getRootDir($baseDir, $settings));
                echo '</ul>';
            ...
            if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
                _e('Select root folder', DCE_TEXTDOMAIN);
            }
        }
    }
    ...
    public function dirToHtml($dir, $hidden = false) {
        global $wpdb;
    ...
    public function displayFileSearch($tit_tx) {
        ?>
            <form action="" class="dce-file-search-form">
                <?php if($tit_tx != '') echo '<h3>'.__($tit_tx, DCE_TEXTDOMAIN).'</h3>'; ?>
                ...
                <div class="text-right dce-search-buttons"><input class="reset" type="reset" value="<?php _e('Reset', DCE_TEXTDOMAIN); ?>"> <input class="find" type="submit" value="<?php _e('Find', DCE_TEXTDOMAIN); ?>"></div>
            </form>
            <br />
        <?php
    }
