...
class DCE_Widget_GoogleMaps extends DCE_Widget_Prototype {
   ...
   protected function _register_controls() {
      ...
      $this->add_control(
         'acf_mapfield', [
            ...
            'options' => $this->get_acf_field_maps(),
            'default' => '0',
         ]
      );
      $this->add_control(
   ...
   protected function render() {
      ...
      if( $settings['use_query'] == '' ){
        ...
        if($settings['enable_infoWindow'] == 'yes' && $settings['use_query'] == '' ){
          
          $infoWindow_str = $settings['custom_infoWindow'];
          
          /*if($settings['acf_mapfield'] != '0'){
      ...
      <div id="el-wgt-map-<?php echo $this->get_id(); ?>" data-address="<?php echo $indirizzo; ?>" data-lat="<?php echo $lat; ?>" data-lng="<?php echo $lng; ?>" data-imgmarker="<?php echo $imageMarker['url']; ?>" data-infowindow="<?php echo $infoWindow_str ?>">
      </div>
   <?php
   }
   ...
   protected function get_acf_field_maps() {
      $acfList = [];
