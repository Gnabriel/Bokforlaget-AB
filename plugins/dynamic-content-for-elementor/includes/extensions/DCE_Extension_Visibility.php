...
class DCE_Extension_Visibility extends DCE_Extension_Prototype {
    ...
    public static $tabs = ['user' => 'User & Role', 'device' => 'Device & Browser', 'datetime' => 'Date & Time', 'post' => 'Current Post', 'context' => 'Context', 'tags' => 'Conditional Tags', 'custom' => 'Custom condition', 'repeater' => 'Advanced', 'fallback' => 'Fallback'];
    ...
    private function add_controls($element, $args) {
        ...
        if ($section == 'repeater') {
            ...
            /* $repeater_fields->add_control(
              'dce_visibility_repeater_tab', [
              'label' => __('Tab', DCE_TEXTDOMAIN),
              'type' => Controls_Manager::SELECT2,
              'options' => self::$tabs,
              ]
              ); */
            //foreach (self::$triggers as $tab => $triggers) {
            $repeater_fields->add_control(
                ...
                'options' => self::$triggers,
                    /* 'condition' => [
                      'dce_visibility_repeater_tab' => $tab,
                      ], */
                    ]
            );
            //}
