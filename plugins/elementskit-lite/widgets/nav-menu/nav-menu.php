...
class Elementskit_Widget_Nav_Menu extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		// $this->add_control(
		// 	'ekit_menu_style_lists',
		// 	[
		// 		'label' => __( 'Menu Style', 'elementskit' ),
		// 		'type' => Controls_Manager::SELECT,
		// 		'default' => 'ekit_menu_style_horizontal',
		// 		'options' => [
		// 			'ekit_menu_style_horizontal' => __( 'Horizontal', 'elementskit' ),
		// 			'ekit_menu_style_vertical'  => __( 'Vertical', 'elementskit' ),
		// 		],
		// 	]
		// );
		
		// $this->add_control(
		// 	'ekit_menu_panel_width',
		// 	[
		// 		'label' => esc_html__( 'Mega Menu Panel Width', 'plugin-domain' ),
		// 		'type' => Controls_Manager::SELECT,
		// 		'default' => 'fited',
		// 		'options' => [
		// 			'full_width'  => esc_html__( 'Full Width', 'plugin-domain' ),
		// 			'fited' => esc_html__( 'Fit to', 'plugin-domain' ),
		// 			'auto' => esc_html__( 'Auto', 'plugin-domain' ),
		// 		],
		// 	]
		// );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'tablet_default' => esc_html__( '#ffffff', 'elementskit' ),
                'devices' => ['tablet'],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color', 'elementskit' ),
					'type' => Controls_Manager::COLOR,
					'desktop_default' => esc_html__( '#000000', 'elementskit' ),
					'tablet_default' => esc_html__( '#000000', 'elementskit' ),
					'devices' => [ 'desktop', 'tablet'],
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'default' => esc_html__( '#707070', 'elementskit' ),
					'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'devices' => [ 'desktop', 'tablet' ],
                'default' => esc_html__( '#000000', 'elementskit' ),
				'selectors' => [
		...
		// Active
		$this->add_control(
			'elementskit_nav_sub_menu_active',
			[
				'label' 	=> esc_html__( 'Active', 'elementskit' ),
				'type' 		=> Controls_Manager::HEADING,
				'separator' => 'before',
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet' ],
                'desktop_default' => esc_html__( '220px', 'elementskit' ),
                'tablet_default' => esc_html__( '200px', 'elementskit' ),
                'selectors' => [
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Humburder Style', 'elementskit' ),
                'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
                'default' => esc_html__( 'rgba(0, 0, 0, 0.5)', 'elementskit' ),
				'selectors' => [
        ...
        $this->add_control(
			...
			[
                ...
                'default' => esc_html__( 'rgba(51, 51, 51, 1)', 'elementskit' ),
				'selectors' => [
    ...
    protected function render_raw( ) {
		...
		if($settings['elementskit_nav_menu'] != '' && wp_get_nav_menu_items($settings['elementskit_nav_menu']) !== false){
			$link = '';
