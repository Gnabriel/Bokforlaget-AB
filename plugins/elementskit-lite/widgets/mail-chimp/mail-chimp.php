...
class Elementskit_Widget_Mail_Chimp extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-mail-submit > i' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-mail-submit > i' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
    ...
    protected function render_raw( ) {
		 ...
		 <div class="ekit-mail-chimp">
			<form method="post" class="ekit-mailChimpForm" data-listed="<?php echo esc_attr($ekit_mail_chimp_select_listed_id);?>">
