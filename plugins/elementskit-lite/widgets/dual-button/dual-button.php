...
class Elementskit_Widget_Dual_Button extends Widget_Base {
    ...
    protected function render_raw( ) {
        ...
        if ( ! empty( $settings['ekit_button_one_link']['url'] ) ) {
            ...
            $button_one_icon  = ($is_new || $migrated) ? '<i class="'.$settings['ekit_button_one_icons']['value'].'"></i>' : '<i class="'. esc_attr($settings['ekit_button_one_icon']) .'" aria-hidden="true"></i>';
        ...
        $button_two_icon  = ($is_new || $migrated) ? '<i class="'.$settings['ekit_button_two_icons']['value'].'"></i>' : '<i class="'.$settings['ekit_button_two_icon'].'"></i>';
